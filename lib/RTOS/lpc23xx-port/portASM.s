...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;Note from Nishant;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; The function vPortYieldProcessor, in the original freeRTOS code, was the only SWI function.
; So no matter which SWI was invoked, a context switch was done, refer to the above paragraph for more details.
; This is changed using the code below. The context switch has been put in SWI 31, a routine has been placed to 
; check the current swi number, thus being able to use swi now with user program as well
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
T_Bit           EQU     0x20
...
;	PRESERVE8
	...
	CMP		R12, #0x0000001F
	BEQ		SWI31
	;these 2 instructions have been added to add compatibility features with LPC1769 SVC calls
	;the code to all swi calls from array table SWI_PTR_TABLE is left for compatibility with older versions
...
vPortYield
	...
	SVC 31	;SWI 31 is used, as the first 16 is used by the library
	bx lr
