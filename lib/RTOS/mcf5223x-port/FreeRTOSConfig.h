 ...
 * TIME=(2 * 2^prescaler/SYSTEM CLOCK) * reload value
 * NOTE:
 *	1)prescaler value range= 0 to 15												
 *	2)reload value range = 1 to 65535(0xffff)													
 *	eg:																			 
 *	if: SYSTEM CLOCK =60MHz,prescaler=1 & reload value = 15000					 	
 *	time=(2*2^1/60MHz)*15000=1ms										
 *
 ****************************************************************************************************************/						
#define portPRESCALER				1
#define RELOAD_TIME					15000
